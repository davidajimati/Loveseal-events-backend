...
export default function registerAccommodationRoutes(app: Router) {
   ...
   *         application/json:
   *           schema:
   *             $ref: '#/components/schemas/GetFacilityRequest'
   *     responses:
   *       200:
  ...
  /**
   * @swagger
   * /accommodation/admin/hostels/{facilityId}:
   *   get:
   *     summary: Get hotel rooms by facility ID (Admin)
   *     tags: [Accommodation]
   *     security:
   ...
   *         description: Facility not found
   */
  router.get("/admin/hostels/:facilityId", adminAuth, controller.getHostels);
