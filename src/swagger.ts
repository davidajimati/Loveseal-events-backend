...
const options: swaggerJSDoc.Options = {
      ...
      schemas: {
        ...
        CreateUserProfileRequest: {
          ...
          properties: {
            ...
            maritalStatus: { type: "string", enum: ["SINGLE", "MARRIED", "SEPARATED", "DIVORCED", "WIDOWED"], nullable: true },
            employmentStatus: { type: "string", enum: ["EMPLOYED", "UNEMPLOYED", "SELF_EMPLOYED"], nullable: true },
        ...
        UpdateUserProfileRequest: {
          ...
          properties: {
            ...
            maritalStatus: { type: "string", enum: ["SINGLE", "MARRIED", "SEPARATED", "DIVORCED", "WIDOWED"] },
        ...
        CreateAdminUserRequest: {
          ...
          properties: {
            ...
            email: { type: "string", format: "email" },
            role: { type: "string", enum: ["ADMIN", "SPECTATOR", "EVENT_MANAGER", "FINANCE_ADMIN", "ACCOMMODATION_ADMIN"] },
    ...
    apis: [
    "./src/index.ts",
        "./src/api/accommodation/accommodation.routes.ts",
        ...
        "./src/api/billing/billing.routes.ts",
